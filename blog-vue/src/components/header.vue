...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg03.jpg)'}">
		<div class="scene">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"今天写点什么好呢？"}}
...
.h-information {
	...
	font-size: 16px;
	opacity: 0.98;
	background: rgba(228, 233, 235, 0.4);
	border-radius: 5px;
	z-index: 1;
